...
async function createUser() {
  try {
    const userCredential = await createUserWithEmailAndPassword(auth, "neshlassi@hackthecore.com", "HTC@2007");
    console.log("Success! Automatically created user:", userCredential.user.email);
  } catch (error) {
